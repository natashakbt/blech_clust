        ...
        try:
            ...
            for cluster in range(2,cluster_num+1):
                ...
                fig1.savefig(data_dir + \
                    '/Plots/{0}/{1}_clusters_waveforms_ISIs/cluster{1}_umap.png'.\
                ...
                fig2.savefig(data_dir + \
                    '/Plots/{0}/{1}_clusters_waveforms_ISIs/cluster{1}_umap_hist.png'.\
                    format(electrode_num, cluster),
                    dpi = 300)
                plt.close(fig2)
                ...
                fig3.savefig(data_dir + \
                    '/Plots/{0}/{1}_clusters_waveforms_ISIs/cluster{1}_umap_timeseries.png'.\
                    format(electrode_num, cluster),
                    dpi = 300)
                plt.close(fig3)
