...
np.save('./spike_waveforms/electrode%i/spike_waveform_derivative.npy' % electrode_num, slices_derivatives)
...
np.save('./spike_waveforms/electrode%i/pca_waveform_derivative.npy' % electrode_num, pca_derivatives)
