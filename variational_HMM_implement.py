...
transition_pseudocounts = 2*np.random.random((num_states, num_states)), emission_pseudocounts = 2*np.random.random((num_states, num_emissions)), start_pseudocounts = 2*np.random.random(num_states), verbose = False)
