...
def dejitter(slices, spike_times, spike_snapshot = [0.5, 1.0], sampling_rate = 30000.0):
        ...
        for i in range(len(slices)):
                ...
                # Only accept spikes if the interpolated minimum has shifted by less than 
                #1/10th of a ms (3 samples for a 30kHz recording, 30 samples after interpolation)
                ...
                cond1 =np.abs(minimum - int((spike_snapshot[0] +0.1)*(sampling_rate/100.0))) \
